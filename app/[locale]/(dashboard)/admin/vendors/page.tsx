    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-black uppercase tracking-tighter italic">Vendor Management</h1>
                    <p className="text-muted-foreground text-sm">Monitor and approve marketplace merchants.</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-white dark:bg-white/5 border rounded-2xl p-6">
                    ...
                    <p className="text-sm font-bold text-muted-foreground uppercase tracking-wider">Total Vendors</p>
            ...
            <div className="bg-white dark:bg-white/5 border rounded-2xl overflow-hidden shadow-sm">
                <div className="p-4 border-b bg-gray-50/30 dark:bg-white/5 flex items-center justify-between">
                    <div className="relative w-full max-w-md">
                        ...
                        <Input placeholder="Search by name, email or city..." className="pl-9 bg-white dark:bg-transparent" />
                    </div>
                </div>
                        ...
                        <tbody className="divide-y divide-gray-100 dark:divide-white/5">
                            {vendors.map((vendor) => (
                                <tr key={vendor.id} className="hover:bg-gray-50/30 dark:hover:bg-white/5 transition-colors">
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex flex-col">
                                            <span className="text-sm font-bold">{vendor._count.products} Products</span>
                                            <span className="text-[10px] text-muted-foreground">{vendor.category.name}</span>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4">
